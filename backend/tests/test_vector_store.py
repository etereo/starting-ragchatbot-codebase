...
class TestVectorStore:
    ...
    def test_search_with_course_name_resolution(self, mock_chroma_client):
        ...
        with patch('chromadb.PersistentClient', return_value=mock_chroma_client):
            ...
            catalog_call = mock_chroma_client.collections['course_catalog'].query.call_args
            assert catalog_call[1]['query_texts'] == ["ML"]
            
            # Verify content search used resolved course name
            content_call = mock_chroma_client.collections['course_content'].query.call_args
            assert content_call[1]['where'] == {"course_title": "Introduction to Machine Learning"}
    ...
    def test_search_chromadb_exception(self, mock_chroma_client):
        ...
        with patch('chromadb.PersistentClient', return_value=mock_chroma_client):
            ...
            mock_chroma_client.collections['course_content'].query.side_effect = Exception("DB Error")
    ...
    def test_resolve_course_name_exception(self, mock_chroma_client):
        ...
        with patch('chromadb.PersistentClient', return_value=mock_chroma_client):
            ...
            mock_chroma_client.collections['course_catalog'].query.side_effect = Exception("DB Error")
    ...
    def test_add_course_metadata(self, mock_chroma_client, sample_course):
        ...
        with patch('chromadb.PersistentClient', return_value=mock_chroma_client):
            ...
            catalog_call = mock_chroma_client.collections['course_catalog'].add.call_args
    ...
    def test_add_course_content(self, mock_chroma_client, sample_course_chunks):
        ...
        with patch('chromadb.PersistentClient', return_value=mock_chroma_client):
            ...
            content_call = mock_chroma_client.collections['course_content'].add.call_args
    ...
    def test_clear_all_data(self, mock_chroma_client):
        ...
        with patch('chromadb.PersistentClient', return_value=mock_chroma_client):
            ...
            assert mock_chroma_client.get_or_create_collection.call_count >= 4  # 2 initial + 2 recreated
    ...
    def test_get_existing_course_titles_exception(self, mock_chroma_client):
        ...
        with patch('chromadb.PersistentClient', return_value=mock_chroma_client):
            ...
            mock_chroma_client.collections['course_catalog'].get.side_effect = Exception("DB Error")
    ...
    def test_complete_search_workflow(self, mock_chroma_client):
        ...
        with patch('chromadb.PersistentClient', return_value=mock_chroma_client):
            ...
            mock_chroma_client.collections['course_content'].query.return_value = {
                ...
                'metadatas': [
                    {"course_title": "Introduction to Machine Learning", "lesson_number": 1, "chunk_index": 5},
                    {"course_title": "Introduction to Machine Learning", "lesson_number": 3, "chunk_index": 12}
                ],
                'distances': [[0.88, 0.82]]
            }
