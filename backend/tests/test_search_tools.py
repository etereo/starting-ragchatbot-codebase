...
class TestCourseSearchTool:
    ...
    def test_execute_with_course_filter(self, mock_vector_store):
        ...
        mock_vector_store.search.return_value = SearchResults(
            ...
            metadata=[{
                "course_title": "Advanced ML Course",
                "lesson_number": 3
            }],
            distances=[0.90]
        )
    ...
    def test_execute_result_with_links(self, mock_vector_store):
        ...
        # Check links tuple
        assert len(tool.last_links) == 1
        assert tool.last_links[0] == ("Test Course - Lesson 1", "https://example.com/lesson1")
...
class TestSearchToolsIntegration:
    ...
    def test_search_tool_stores_sources_correctly(self, mock_vector_store):
        ...
        mock_vector_store.get_lesson_link.side_effect = lambda course, lesson: "https://example.com/lesson" if lesson else None
        mock_vector_store.get_course_link.side_effect = lambda course: "https://example.com/course"
